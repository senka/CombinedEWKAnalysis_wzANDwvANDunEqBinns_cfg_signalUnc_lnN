...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName(AnomalousCouplingModel):
...
#        self.modelBuilder.factory_('RooATGCProcessScaling_wz::Scaling_%s(W_pt_%s,dkg,lZ,dg1,Scaling_base_pdf_%s,"%s")'%(scalerName,lepchannel,scalerName,filename))
        self.modelBuilder.factory_('RooATGCProcessScaling_wz_2Dpol2::Scaling_%s(W_pt_%s,dkg,lZ,Scaling_base_pdf_%s,"%s")'%(scalerName,lepchannel,scalerName,filename))
        ...
        elif ( self.mode == 'dkzdg1zToCB' ):
            self.modelBuilder.out.function('Scaling_%s'%scalerName).setLimitType(2)
            self.modelBuilder.out.var('dkg').setVal(0)
            self.modelBuilder.out.var('dkg').setConstant(True)  
        elif ( self.mode == 'dg1zlZToCWWW' ):
            self.modelBuilder.out.function('Scaling_%s'%scalerName).setLimitType(3)
            self.modelBuilder.out.var('dkg').setVal(0)
            self.modelBuilder.out.var('dkg').setConstant(True)  
        elif ( self.mode == 'dg1lZ' ):
            self.modelBuilder.out.function('Scaling_%s'%scalerName).setLimitType(4)
            self.modelBuilder.out.var('dkg').setVal(0)
            self.modelBuilder.out.var('dkg').setConstant(True)  
        elif ( self.mode == 'dkgdg1' ):
            self.modelBuilder.out.function('Scaling_%s'%scalerName).setLimitType(5)
...
dkglZModel_wz = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName('dkglZ')
dkzdg1zToCWModel_wz = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName('dkzdg1zToCW')
dkzdg1zToCBModel_wz = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName('dkzdg1zToCB')
dg1zlZToCWWWModel_wz = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName('dg1zlZToCWWW')
dg1lZModel_wz = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName('dg1lZ')
dkgdg1Model_wz = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_2Dpol2_chName('dkgdg1')
