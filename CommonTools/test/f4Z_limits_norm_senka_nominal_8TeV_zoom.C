...
//=========  (Mon Jun 16 11:20:28 2014) by ROOT version5.34/03
   ...
   canv->Range(-0.009625,-1.306695,0.009625,1.256299);
   canv->SetFillColor(0);
   ...
   Graph_Graph_Graph15->SetMinimum(0.1202093);
   Graph_Graph_Graph15->SetMaximum(8.863406);
   ...
   Graph_Graph_Graph26->SetMinimum(0.1340401);
   Graph_Graph_Graph26->SetMaximum(12.38298);
   ...
   Graph_Graph_Graph37->SetMinimum(0.1700915);
   Graph_Graph_Graph37->SetMaximum(6.187155);
   ...
   Graph_Graph_Graph48->SetMinimum(0.1887958);
   Graph_Graph_Graph48->SetMaximum(8.928979);
   ...
   Graph_Graph_Graph13->SetMinimum(0.1350532);
   Graph_Graph_Graph13->SetMaximum(2.100582);
   ...
   Graph_Graph_Graph24->SetMinimum(0.1504912);
   Graph_Graph_Graph24->SetMaximum(3.473024);
   ...
   TH1F *Graph_Graph_Graph15 = new TH1F("Graph_Graph_Graph15","Graph",100,-0.0075,-0.0015);
   Graph_Graph_Graph15->SetMinimum(0.2575195);
   Graph_Graph_Graph15->SetMaximum(4.113574);
   Graph_Graph_Graph15->SetDirectory(0);
   Graph_Graph_Graph15->SetStats(0);
   ...
   TH1F *Graph_Graph_Graph26 = new TH1F("Graph_Graph_Graph26","Graph",100,0.0015,0.0075);
   Graph_Graph_Graph26->SetMinimum(0.2847656);
   Graph_Graph_Graph26->SetMaximum(6.173047);
   Graph_Graph_Graph26->SetDirectory(0);
   Graph_Graph_Graph26->SetStats(0);
   ...
   TH1F *Graph_Graph_Graph37 = new TH1F("Graph_Graph_Graph37","Graph",100,-0.0075,-0.0015);
   Graph_Graph_Graph37->SetMinimum(0.1354951);
   Graph_Graph_Graph37->SetMaximum(2.094205);
   Graph_Graph_Graph37->SetDirectory(0);
   Graph_Graph_Graph37->SetStats(0);
   ...
   TH1F *Graph_Graph_Graph48 = new TH1F("Graph_Graph_Graph48","Graph",100,0.0015,0.0075);
   Graph_Graph_Graph48->SetMinimum(0.1510195);
   Graph_Graph_Graph48->SetMaximum(3.463401);
   Graph_Graph_Graph48->SetDirectory(0);
   Graph_Graph_Graph48->SetStats(0);
