...
//=========  (Wed Jun 25 15:00:33 2014) by ROOT version5.34/03
   TCanvas *canv = new TCanvas("canv", "limits canvas",40,62,600,600);
   canv->Range(-0.009625,-1.276135,0.009625,1.252904);
   canv->SetFillColor(0);
   ...
   Graph_Graph_Graph15->SetMinimum(0.1279684);
   Graph_Graph_Graph15->SetMaximum(14.37403);
   ...
   Graph_Graph_Graph26->SetMinimum(0.1434574);
   Graph_Graph_Graph26->SetMaximum(18.26628);
   ...
   Graph_Graph_Graph37->SetMinimum(0.2148443);
   Graph_Graph_Graph37->SetMaximum(9.696326);
   ...
   Graph_Graph_Graph48->SetMinimum(0.239232);
   Graph_Graph_Graph48->SetMaximum(12.90055);
   ...
   Graph_Graph_Graph13->SetMinimum(0.02203165);
   Graph_Graph_Graph13->SetMaximum(2.928724);
   ...
   Graph_Graph_Graph24->SetMinimum(0.2690222);
   Graph_Graph_Graph24->SetMaximum(4.538059);
   ...
   TH1F *Graph_Graph_Graph15 = new TH1F("Graph_Graph_Graph15","Graph",100,-0.0075,-0.0015);
   Graph_Graph_Graph15->SetMinimum(0.4412109);
   Graph_Graph_Graph15->SetMaximum(5.915039);
   Graph_Graph_Graph15->SetDirectory(0);
   Graph_Graph_Graph15->SetStats(0);
   ...
   TH1F *Graph_Graph_Graph26 = new TH1F("Graph_Graph_Graph26","Graph",100,0.0015,0.0075);
   Graph_Graph_Graph26->SetMinimum(0.4816406);
   Graph_Graph_Graph26->SetMaximum(8.574609);
   Graph_Graph_Graph26->SetDirectory(0);
   Graph_Graph_Graph26->SetStats(0);
   ...
   TH1F *Graph_Graph_Graph37 = new TH1F("Graph_Graph_Graph37","Graph",100,-0.0075,-0.0015);
   Graph_Graph_Graph37->SetMinimum(0.02436727);
   Graph_Graph_Graph37->SetMaximum(2.916694);
   Graph_Graph_Graph37->SetDirectory(0);
   Graph_Graph_Graph37->SetStats(0);
   ...
   TH1F *Graph_Graph_Graph48 = new TH1F("Graph_Graph_Graph48","Graph",100,0.0015,0.0075);
   Graph_Graph_Graph48->SetMinimum(0.2696354);
   Graph_Graph_Graph48->SetMaximum(4.518816);
   Graph_Graph_Graph48->SetDirectory(0);
   Graph_Graph_Graph48->SetStats(0);
