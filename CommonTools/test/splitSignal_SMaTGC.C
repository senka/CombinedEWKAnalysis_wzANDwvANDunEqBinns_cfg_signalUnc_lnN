  ...
  */
  ...
  for (int i=0;i<list_histos->GetEntries();i++){
	...
	cout << "@@@@@@@@@@ correcting dibosonSM... -> yield: "<<plot_diboson->Integral() << endl;
      ...
      // add flat unc (PU and lepton_energy_scale of 2%)
      TH1D * flat_up=new TH1D();
      flat_up=(TH1D*)(plot_diboson->Clone("nameflat1"));
      flat_up->Scale(1.02);
      flat_up->Write("dibosonSM_CMS_hzz2l2v_puUp");
      flat_up->Write("dibosonSM_CMS_hzz2l2v_lesUp");
      TH1D * flat_down=new TH1D();
      flat_down=(TH1D*)(plot_diboson->Clone("nameflat1"));
      flat_down->Scale(0.98);
      flat_down->Write("dibosonSM_CMS_hzz2l2v_puDown");
      flat_down->Write("dibosonSM_CMS_hzz2l2v_lesDown");
	...
	plot_aTGC->SetBinContent(j,1.);
      ...
      // add flat unc (PU and lepton_energy_scale of 2%)
      TH1D * flatatgc_up=new TH1D();
      flatatgc_up=(TH1D*)(plot_aTGC->Clone("nameflatatgc1"));
      flatatgc_up->Scale(1.02);
      flatatgc_up->Write("diboson_CMS_hzz2l2v_puUp");
      flatatgc_up->Write("diboson_CMS_hzz2l2v_lesUp");
      TH1D * flatatgc_down=new TH1D();
      flatatgc_down=(TH1D*)(plot_aTGC->Clone("nameflatatgc1"));
      flatatgc_down->Scale(0.98);
      flatatgc_down->Write("diboson_CMS_hzz2l2v_puDown");
      flatatgc_down->Write("diboson_CMS_hzz2l2v_lesDown");
