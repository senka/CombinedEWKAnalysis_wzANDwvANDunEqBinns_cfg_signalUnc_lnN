...
#            theta[i] = theWS.var("%s"%signal_shapeSyst[i])
    ...
    aTGCPdf = RooATGCSemiAnalyticPdf_wz('ATGCPdf_WWgammaZ_WV_atgc_semileptonic_%s'%codename,
                                        ...
                                        dg1,
                                        dibosonPdf,
                                        '%s/signal_WV_%s_f5z_ifLessThen1SetTo1_2604Files_SMaTGCfit.root'%(basepath,codename),
                                        limtype
                                        )

    print '****************************************************** using file: %s/signal_WV_%s_f5z_ifLessThen1SetTo1_2604Files_SMaTGCfit.root**************'%(basepath,codename)
