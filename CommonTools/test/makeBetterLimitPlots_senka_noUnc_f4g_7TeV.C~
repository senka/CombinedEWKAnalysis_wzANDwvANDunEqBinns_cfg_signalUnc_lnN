...
void makeBetterLimitPlots_senka_CLsUnc_f4g_7TeV() {

  string folder = "limits_f4g_7TeV_EWK";
  ...
  string dbpars[] = {"-0.007", "-0.008", "-0.009", "-0.01", "-0.012", "-0.014", "-0.016", "-0.018", "-0.02",  "0.007", "0.008", "0.009", "0.01", "0.012", "0.014", "0.016", "0.018", "0.02"}; 
  string parName = "f_{4}^{#gamma}";
  bool is7TGeV = true; 
  bool is8TGeV = false; 
  ...
  for(UInt_t i=0; i<npts; ++i) {
    ...
    TFile myfile( (folder+"/"+dbpars[i]+"/higgsCombine_senkaCLsUnc.Asymptotic.mH120.root").c_str() ); 
  ...
  if( savePlots ) {
    ...
    if(is7TGeV) plotName += "_senka_CLsUnc_7TeV";
    if(is8TGeV) plotName += "_senka_CLsUnc_8TeV";
