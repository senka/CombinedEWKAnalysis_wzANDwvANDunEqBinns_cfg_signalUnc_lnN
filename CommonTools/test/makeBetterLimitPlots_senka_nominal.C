...
void makeBetterLimitPlots_senka_nominal() {

  string folder = "cardsShape";
  //string dbpars[] = {"-0.02", "-0.01", "-0.005", "-0.002", "0", "0.002", "0.005", "0.01", "0.02"}; 
  string dbpars[] = {"-0.02", "-0.018", "-0.016", "-0.014", "-0.012", "-0.01", "-0.009", "-0.008", "-0.007", "-0.006", "-0.005", "-0.004", "-0.003", "-0.002", "0", "0.002", "0.003", "0.004", "0.005", "0.006", "0.007", "0.008", "0.009", "0.01", "0.012", "0.014", "0.016", "0.018", "0.02"}; 
  ...
  for(UInt_t i=0; i<npts; ++i) {
    ...
    TFile myfile( (folder+"/"+dbpars[i]+"/higgsCombine_senkaallUnc_nominal.Asymptotic.mH120.root").c_str() ); 
  ...
  if( savePlots ) {
    ...
    if(is7TGeV) plotName += "_senka_nominal_7TeV";
    if(is8TGeV) plotName += "_senka_nominal_8TeV";
