...
//=========  (Wed Jun 25 22:42:02 2014) by ROOT version5.34/03
   TCanvas *canv = new TCanvas("canv", "limits canvas",40,62,600,600);
   canv->Range(-0.009625,-1.194885,0.009625,1.811227);
   canv->SetFillColor(0);
   ...
   Graph_Graph1->SetMinimum(0.1722107);
   Graph_Graph1->SetMaximum(12.3936);
   ...
   Graph_Graph2->SetMinimum(0.1919586);
   Graph_Graph2->SetMaximum(17.80158);
   ...
   Graph_Graph3->SetMinimum(0.2431131);
   Graph_Graph3->SetMaximum(8.651163);
   ...
   Graph_Graph4->SetMinimum(0.2703743);
   Graph_Graph4->SetMaximum(12.7537);
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,-0.0075,-0.0015);
   Graph_Graph1->SetMinimum(0.192881);
   Graph_Graph1->SetMaximum(3.086097);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0.0015,0.0075);
   Graph_Graph2->SetMinimum(0.2169051);
   Graph_Graph2->SetMaximum(5.147951);
   Graph_Graph2->SetDirectory(0);
   Graph_Graph2->SetStats(0);
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,-0.0075,-0.0015);
   Graph_Graph1->SetMinimum(0.3673828);
   Graph_Graph1->SetMaximum(5.751367);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0.0015,0.0075);
   Graph_Graph2->SetMinimum(0.4078125);
   Graph_Graph2->SetMaximum(8.720313);
   Graph_Graph2->SetDirectory(0);
   Graph_Graph2->SetStats(0);
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,-0.0075,-0.0015);
   Graph_Graph3->SetMinimum(0.1934275);
   Graph_Graph3->SetMaximum(3.077372);
   Graph_Graph3->SetDirectory(0);
   Graph_Graph3->SetStats(0);
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,0.0015,0.0075);
   Graph_Graph4->SetMinimum(0.2174157);
   Graph_Graph4->SetMaximum(5.133759);
   Graph_Graph4->SetDirectory(0);
   Graph_Graph4->SetStats(0);
