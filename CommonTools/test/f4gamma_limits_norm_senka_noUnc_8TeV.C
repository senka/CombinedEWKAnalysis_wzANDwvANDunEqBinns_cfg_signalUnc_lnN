...
//=========  (Wed Jun 25 22:45:41 2014) by ROOT version5.34/03
   TCanvas *canv = new TCanvas("canv", "limits canvas",40,62,600,600);
   canv->Range(-0.009625,-1.225057,0.009625,1.665273);
   canv->SetFillColor(0);
   ...
   Graph_Graph1->SetMinimum(0.192786);
   Graph_Graph1->SetMaximum(13.05843);
   ...
   Graph_Graph2->SetMinimum(0.1564264);
   Graph_Graph2->SetMaximum(8.916319);
   ...
   Graph_Graph3->SetMinimum(0.2715397);
   Graph_Graph3->SetMaximum(9.643201);
   ...
   Graph_Graph4->SetMinimum(0.2193335);
   Graph_Graph4->SetMaximum(6.402441);
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,-0.0075,-0.0015);
   Graph_Graph1->SetMinimum(0.2140728);
   Graph_Graph1->SetMaximum(4.175794);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0.0015,0.0075);
   Graph_Graph2->SetMinimum(0.003734206);
   Graph_Graph2->SetMaximum(2.278395);
   Graph_Graph2->SetDirectory(0);
   Graph_Graph2->SetStats(0);
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,-0.0075,-0.0015);
   Graph_Graph1->SetMinimum(0.4095703);
   Graph_Graph1->SetMaximum(6.812305);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0.0015,0.0075);
   Graph_Graph2->SetMinimum(0.004394531);
   Graph_Graph2->SetMaximum(4.346191);
   Graph_Graph2->SetDirectory(0);
   Graph_Graph2->SetStats(0);
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,-0.0075,-0.0015);
   Graph_Graph3->SetMinimum(0.2146062);
   Graph_Graph3->SetMaximum(4.159328);
   Graph_Graph3->SetDirectory(0);
   Graph_Graph3->SetStats(0);
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,0.0015,0.0075);
   Graph_Graph4->SetMinimum(0.00512571);
   Graph_Graph4->SetMaximum(2.272669);
   Graph_Graph4->SetDirectory(0);
   Graph_Graph4->SetStats(0);
